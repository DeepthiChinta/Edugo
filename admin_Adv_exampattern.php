...
<ul>
    ...
    <div class="girl_sidebar" style="position:fixed;left:1200px;top:150px;">
        <img src="https://i.pinimg.com/originals/73/b1/d2/73b1d221c14a2a6e8275da6b1299aaaf.jpg" width="300px" height="450px">
...
<div class="main_body">
  ...
  <ul>
    <li>JEE Advanced is a computer-based test.</li>
    <li>The exam consists of two papers - Paper 1 and Paper 2, both of which are mandatory.</li>
    <li>Each paper has a duration of 3 hours.</li>
    <li>Both papers are divided into three sections - Physics, Chemistry, and Mathematics.</li>
    <li>Each section consists of both Multiple Choice Questions (MCQs) and Numerical Value Answer (NVA) type questions.</li>
    <li>Negative marking is applicable for MCQs. A wrong answer will result in a negative score of -1 or -2 marks depending on the question pattern.</li>
    <li>The questions are designed to test the understanding, application, and analytical skills of the candidates.</li>
    <li>The syllabus for JEE Advanced includes topics from Class 11 and 12 of Physics, Chemistry, and Mathematics.</li>
  </ul>
<h1>Marking Scheme</h1>
<h2>JEE Advanced Marking Scheme - Paper 1</h2>
<table class = "Marks Scheme">
  <tr>
    <th>Section</th>
  ...
  <tr>
    <td>1</td>
    <td colspan="2">Question with a single correct answer</td>
    <td > 4</td>
    <td>  -1</td>
  </tr>
  <tr>
    <td>  3</td>
    <td colspan="2">Question with a Single Digit Integer as Answer</td>
    <td>   3</td>
    <td>  0</td>
  </tr>
...
<h2>JEE Advanced Marking Scheme - Paper 2</h2>
<table class = "Marks Scheme2">
  <tr>
    <th>Section</th>
    <th colspan="2">Type Of Question</th>
    <th>Awarded Marks</th>
  ...
  <tr>
    <td>2</td>
    <td colspan="2">Question with One or More Correct Answers</td>
    <td>4</td>
    <td>-2</td>
  </tr>
  <tr>
    <td>3</td>
    <td colspan="2">Comprehension Type Question</td>
    <td>3</td>
    <td>0</td>
  </tr>
