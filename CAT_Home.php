...
<div class="user-menu"> <li> <a href="#"> Study Materials </a> </li>
  ...
  <div class="user-menu">
    ...
    <div class="main_body">
        <h1>About CAT 2023</h1>
        <p>
            CAT Exam is the national-level management entrance test conducted by the Indian Institute of Management for admission into 20 IIMs 
            and 100+ B-schools across India. Every year, one of the older IIMs is tasked with administering the exam.
            More than 2 lakh aspirants appear for the CAT exam annually but only a few thousand make it to their desired top B-schools.
            Apart from IIMs, other reputed B-schools that accept CAT scores include MDI (Gurgaon), IITs, SP Jain (Mumbai), IMT(Ghaziabad), FMS(Delhi), KJ Somaiya Institute of Management Studies (Mumbai),
            Great Lakes Institute of Management(Chennai), Xavier Institute of Management, Bhubaneshwar, to name a few.
        </p>
        <p>The Common Admission Test (CAT) is India’s most prestigious national-level entrance examination, which permits aspirants to get into top management institutes. There is no doubt that it is the biggest MBA entrance test in the country. 
            The IIMs (Indian Institute of Management) conduct this Common Admission Test on a rotational basis.</p>
        <p>CAT Exam 2023 is expected to be held on 26th November 2023, the last Sunday of November. It is a computer-based test that is held across 156 cities in India.Now If you are a B-school aspirant planning to take up CAT 2023,
        gear up with your CAT preparation right now.</p>
