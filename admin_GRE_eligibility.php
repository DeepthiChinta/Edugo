...
<input type="checkbox" id="check">
    ...
    <p>The candidates must have a graduation degree at the time of appearing for the exam. The degree must be authentic and can be from any discipline from any recognised University.</p>
    
    <strong>Nationality</strong>
    <p>Candidates from across the globe are eligible to apply for the GRE exam. However, they must have completed their graduation from recognised institutes. </p>
    
    <strong>Age Limit</strong>
    <p>There is no age limit for the GRE 2023,thy must have completed their graduation from recognised institutes.</p>

    <strong>Number of Attempts</strong>
    <p>You can take the GRE General Test once every 21 days, up to five times within any continuous rolling 12- month period (365 days). This applies even if you cancelled your scores on a test taken previously. </p>
    </div>
    </div>
