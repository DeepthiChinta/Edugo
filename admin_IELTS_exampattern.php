...
<h1> Exam Pattern </h1>
<p>In order to understand the IELTS Pattern deeply, candidates should also know the IELTS Syllabus.

IELTS Syllabus includes different sections, Listening, Reading, Writing, and Speaking. The complete test duration is 2 hours and 45 minutes. </p>

<ul> 
<li> <p> <b> Listening:</b> The total length of this section is 30 minutes and it is divided into four parts candidates have to answer different types of 40 questions.  </p> </li>
<li> <p> <b> Reading:</b>  The reading section comprises three texts of general interest that deals with issues that are suitable for candidates going to pursue post-graduate or undergraduate program. The total time for this section is 60 minutes and it comprises almost 40 questions. </p> </li>
<li> <p> <b> Writing:</b>  The duration of this section is 60 minutes and it comprises of two tasks. In Task 1, a candidate has to write a summary based on a graph/table/process in at least 150 words. In Task 2, a candidate has to write a discursive essay of at least 250 words. </p> </li>
<li> <p> <b> Speaking:</b>  The total time of this section varies from 11 to 14 minutes in which candidates have to give a face-to-face interview. With the help of this section, the candidates are checked whether they can communicate effectively and present their ideas coherently in English. </p> </li>
</ul>
</div>
