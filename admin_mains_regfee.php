...
<input type="checkbox" id="check">
    ...
    <p>
      The JEE Mains Exam is one of the most prestigious names among the engineering entrance exams is a national-level exam conducted for the 12th standard students seeking admission in courses such as B.Tech, B.E, B.Arch, and B.Planning. 
    </p>
      <ul>
        <li>The JEE Main Registration constitutes of two papers. The Paper I paves the way for the B.E / B.Tech courses and Paper II is for the B. Arch / B. Planning courses.</li>
        <li>The JEE Main Registration fee would differ for both accordingly. The other factor that impacts the JEE Main Registration fee is the reservation category the candidate belongs to.</li> 
        <li>The fee for General and OBC category candidates differs a lot from what it is kept for the SC/ST/Transgenders and PwD candidates.</li> 
      </ul>

      <table>
        <tr>
          <th colspan="2">Fee payable for JEE Main - 2023</th>
          <th>Gender</th>
          <th>In India(Fee in )</th>
        ...
        <tr>
          <td rowspan="5">Paper 1:B.E/B.tech and Paper 2A: B.Arch <br>  or <br> Paper 1:B.E/B.tech & Paper 2B: B.Planning <br> or <br> Paper 1:B.E/B.tech and Paper 2A: B.Arch & Paper 2B:B.Planning <br> or <br> Paper 2A:B.Arch & Paper 2B:B.Planning</td>
          <td rowspan="2">General/Gen-EWS/OBC(NCL)</td>
          <td>Male</td>
          <td>1300</td>
          <td>6000</td>
