...
<div class="main_body">
    ...
    <strong>JEE_Advanced  2022 Cut-off Marks & Percentile for Top IITs 2022 Rank-wise, Branch wise
    </strong>
    <br><br>
    ...
    padding-left: 0;">
        <tbody>
            ...
            <tr>
            <td rowspan="2">&nbsp;</p>
            <p><strong>College</strong></td>
            <td colspan="2"><strong>OBC NCL</strong></td>
