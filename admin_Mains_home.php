...
<input type="checkbox" id="check">
    ...
    <div class="main_body">
        <h1>About JEE(Main) 2023</h1>
        <p>The Joint Entrance Examination, JEE (Main) comprises two papers. <strong>Paper 1</strong> is conducted for admission to Undergraduate Engineering Programs (<strong>B.E/B.Tech</strong>.) at NITs, IIITs, other Centrally Funded Technical Institutions (CFTIs), and Institutions/Universities funded/recognized by participating State Governments. JEE (Main) is also an eligibility test for JEE (Advanced), which is conducted for admission to IITs. <strong>Paper 2</strong> is conducted for admission to <strong>B. Arch and B. Planning</strong> courses in the country.</p>
        <p>The JEE (Main) &#8211; 2023 will be conducted in <strong>02</strong> (<strong>two) sessions</strong> for admissions in the next academic session. The candidates will thus benefit in the following ways:</p>
        <ul>
            <li>This will give <strong>two </strong>opportunities to the candidates to improve their scores in the examination if they are not able to give their best in one attempt.</li>
            <li>In the first attempt, the students will get a first-hand experience of taking an examination and will know their mistakes which they can improve while attempting for the second time.</li>
            <li>This will reduce the chances of dropping a year and droppers would not have to waste an entire year.</li>
            <li>If anyone missed the examination due to reasons beyond control (such as the Board examination), then he/she will not have to wait for one entire year.</li>
            <li>A candidate need not appear in both Sessions. However, if a candidate appears in more than one Session then his/her best of the JEE (Main) &#8211; 2023 NTA Scores will be considered for preparation of the Merit List/ Ranking.</li>
        </ul>
