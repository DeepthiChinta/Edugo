...
<input type="checkbox" id="check">
    ...
    <div class="main_body">
       ...
       <p> The Test of English as a Foreign Language (TOEFL) is a standardized test designed to assess the English language ability of non-native speakers. The test is widely accepted by colleges, universities, and agencies in the United States and around the world as a measure of English language proficiency. </p>

        <p> To register for the TOEFL, you will need to follow these steps:  </p>

        <ul> 
        <li> Visit the TOEFL website and create an account.  </li>
        <li> Choose the test delivery method that you prefer: TOEFL iBT (Internet-based test), TOEFL PBT (paper-based test), or TOEFL CBT (computer-based test).  </li>
        <li> Select a test date and location that is convenient for you. The TOEFL is offered multiple times a year at authorized testing centers around the world.  </li>
        <li> Pay the test fee using a credit card or other accepted payment method. The fee varies depending on the test delivery method and location, but it is typically around $200.  </li>
        <li> Print out or save your confirmation page, which includes your test date and location.  </li>
        <li> Arrive at the test center on the day of the test with a valid government-issued identification.  </li>
